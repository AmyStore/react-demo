      ...
      <div className={this.props.className}>
        <div className="owl">
          <div
            className="hand-left hand"
            style={
              focusItem === 1 || focusItem === 2 ? styles.focusHandLeft : {}
            }
          />
          <div
            className="hand-right hand"
            style={
              focusItem === 1 || focusItem === 2 ? styles.focusHandRight : {}
            }
          />
          <div className="arms-box">
            <div
              className="arms arms-left"
              style={
                focusItem === 1 || focusItem === 2 ? styles.focusArmsLeft : {}
              }
            />
            <div
              className="arms arms-right"
              style={
                focusItem === 1 || focusItem === 2 ? styles.focusArmsRight : {}
              }
            />
          </div>
        </div>
        <Form onSubmit={this.registerSubmit} className="registerSubmit">
          ...
          <div className="bottom">
            <span className="gobackBtn" onClick={this.gobackLogin}>
              返回登录
            </span>
            &emsp;
            <Button type="primary" htmlType="submit">
    ...
    return (
      ...
      <div className="container">
        <LoginForm
          className={
            showBox === "login"
              ? "login-box-active login-box"
              : "login-box-leave login-box"
          }
